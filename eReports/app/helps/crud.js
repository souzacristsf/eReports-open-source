module.exports = app => {
    ...
    return {
        ...
        create: (Model, res) => Model.save()
            .then(successOrError.success(res, Return.success), successOrError.error(res)),
        ...
        update: (Model, query, mod, res) => Model.update(query, mod)
            .then(successOrError.success(res, Return.returnUpdateSuccess), successOrError.error(res)),
